  ...
  return (
    <>
      ...
      >
          ...
          My primary focus lies in software development, where I strive to leverage my skills to build innovative solutions that address real-world challenges. In my programming endeavors, I predominantly utilize Python, C++, and Java. I am proficient in many others however, such as, Javascript, HTML, Bash, and SQL. These languages have empowered me to develop diverse projects, ranging from databases and data structures to advanced algorithms and machine learning models. For instance, I have implemented algorithms such as perceptrons and cognitrons, furthering my understanding of artificial neural networks and their applications.
      </motion.p>
